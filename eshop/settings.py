...
CSRF_TRUSTED_ORIGINS = os.environ.get(
    "DJANGO_CSRF_TRUSTED_ORIGINS", default="http://localhost:1337 http://localhost:8080").split(" ")

CORS_ORIGIN_ALLOW_ALL = bool(os.environ.get("DEBUG", default=0))
...
REST_KNOX = {
    ...
    'USER_SERIALIZER': 'my_auth.serializers.UserSerializer',
